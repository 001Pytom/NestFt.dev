...
export default function DashboardPage() {
  ...
  const currentStageProgress =
    progress[userProfile?.current_stage || "beginner"];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Ready to continue building amazing projects? Let&#39;s level up your
            skills!
          </p>
        </motion.div>
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {(userProfile?.current_stage || "beginner")
                  .charAt(0)
                  .toUpperCase() +
                  (userProfile?.current_stage || "beginner").slice(1)}
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span>
                      ...
                      {Math.ceil(currentStageProgress.total * 0.7)} projects
                      (70% required)
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${Math.min(
                          currentStageProgress.percentage,
                          100
                        )}%`,
                      }}
                    />
                ...
                <p className="text-sm">
                  {canAdvanceToNext() ? (
                    <span className="text-green-600 font-medium">
                      🎉 Congratulations! You can now access {getNextStage()}{" "}
                      level projects!
                    </span>
                  ) : (
                    <>
                      Complete{" "}
                      {Math.ceil(currentStageProgress.total * 0.7) -
                        currentStageProgress.completed}{" "}
                      more projects to unlock {getNextStage() || "next"} level
                      projects!
                    </>
                  )}
                </p>
                  ...
                  <div className="text-xs">
                    {stage === userProfile?.current_stage ? (
                      ...
                      <span className="text-gray-500">
                        {userProfile?.current_stage === "beginner" &&
                        stage === "intermediate"
                          ? "Complete 70% of Beginner first"
                          : userProfile?.current_stage === "intermediate" &&
                            stage === "advanced"
                          ? "Complete 70% of Intermediate first"
                          : "Locked"}
                      </span>
                    )}
                  </div>
