...
export default function LeaderboardPage() {
  ...
  }, [loadLeaderboard, user, loadUserPosition]);
            ...
            <div className="space-y-2">
              ...
              {userPosition && user && (
                <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium">
                  ...
                  Your Rank: #{userPosition.rank} out of{" "}
                  {userPosition.totalUsers} developers
                </div>
              )}
            </div>
          </div>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col items-center pt-8">
                <div className="relative">
                  <Avatar className="h-16 w-16 border-4 border-gray-300 shadow-lg">
                    <AvatarImage
                      ...
                      alt={leaderboardData[1]?.full_name || "User"}
                    />
                ...
                <h3 className="font-semibold mt-3 text-center text-sm">
                  {leaderboardData[1]?.full_name || "Anonymous User"}
                </h3>
                <p className="text-2xl font-bold text-gray-600 mt-1">
                  {leaderboardData[1]?.total_points?.toLocaleString() || 0}
                </p>
                <Badge
                  ...
                  variant="outline"
                >
                  {leaderboardData[1]?.current_stage?.charAt(0).toUpperCase() +
                    leaderboardData[1]?.current_stage?.slice(1) || "Beginner"}
                </Badge>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  <Avatar className="h-24 w-24 border-4 border-yellow-400 shadow-xl">
                    <AvatarImage
                      ...
                      alt={leaderboardData[0]?.full_name || "User"}
                    />
                ...
                <h3 className="font-bold mt-3 text-center">
                  {leaderboardData[0]?.full_name || "Anonymous User"}
                </h3>
                ...
                <Badge
                  ...
                  variant="outline"
                >
                  {leaderboardData[0]?.current_stage?.charAt(0).toUpperCase() +
                    leaderboardData[0]?.current_stage?.slice(1) || "Beginner"}
                </Badge>
              </div>
              ...
              <div className="flex flex-col items-center pt-12">
                <div className="relative">
                  <Avatar className="h-14 w-14 border-4 border-amber-400 shadow-lg">
                    <AvatarImage
                      ...
                      alt={leaderboardData[2]?.full_name || "User"}
                    />
                ...
                <h3 className="font-semibold mt-3 text-center text-sm">
                  {leaderboardData[2]?.full_name || "Anonymous User"}
                </h3>
                <p className="text-xl font-bold text-amber-600 mt-1">
                  {leaderboardData[2]?.total_points?.toLocaleString() || 0}
                </p>
                <Badge
                  className={`${getStageColor(
                  ...
                  variant="outline"
                >
                  {leaderboardData[2]?.current_stage?.charAt(0).toUpperCase() +
                    leaderboardData[2]?.current_stage?.slice(1) || "Beginner"}
                </Badge>
              </div>
            </div>
          </motion.div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-3 mt-1">
                            ...
                            <div className="flex items-center gap-1 text-sm text-muted-foreground">
                              ...
                              <span>
                                {userProfile.streak_days || 0} day streak
                              </span>
                            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-secondary">
                    {leaderboardData
                      .reduce((sum, user) => sum + (user.total_points || 0), 0)
                      .toLocaleString()}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Total Points Earned
                ...
                <div>
                  <div className="text-2xl font-bold text-accent">
                    {leaderboardData.reduce(
                      (sum, user) => sum + (user.streak_days || 0),
                      0
                    )}
                  </div>
                  <div className="text-sm text-muted-foreground">
