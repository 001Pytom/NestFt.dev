            ...
            >
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  demonstrating proficiency in web development technologies and completing 70% of required projects
                </p>
              ...
              <div className="flex justify-between items-end">
                ...
                <div className="text-right">
                  <div className="w-24 h-24 border-4 border-primary rounded-full flex items-center justify-center mb-2">
              ...
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
                <p className="text-xs text-gray-400">
                  Certificate ID: NFTD-{selectedCertificate.stage.toUpperCase()}-{user?.id?.slice(0, 8)}-{new Date().getFullYear()}
                </p>
              </div>
            </div>
          </div>
