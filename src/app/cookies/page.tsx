            ...
            <Card className="mb-8">
              ...
              <CardContent>
                  ...
                  <div className="flex items-start justify-between p-4 border rounded-lg">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs bg-success/10 text-success px-2 py-1 rounded">Required</span>
                      </div>
                  ...
                  <div className="flex items-start justify-between p-4 border rounded-lg">
                    ...
                    <div className="ml-4">
                      <button
                        ...
                        className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                          preferences.functional ? 'bg-secondary justify-end' : 'bg-muted justify-start'
                        }`}
                      >
                        <div className="w-4 h-4 bg-white rounded-full"></div>
                      </button>
                  ...
                  <div className="flex items-start justify-between p-4 border rounded-lg">
                    ...
                    <div className="ml-4">
                      <button
                        ...
                        className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                          preferences.marketing ? 'bg-accent justify-end' : 'bg-muted justify-start'
                        }`}
                      >
                        <div className="w-4 h-4 bg-white rounded-full"></div>
                      </button>
                ...
                <div className="flex gap-4 mt-6">
                  ...
                  <Button 
                    variant="outline"
                    onClick={() => setPreferences({ necessary: true, analytics: true, functional: true, marketing: false })}
                  >
                    Accept Recommended
                  </Button>
                </div>
            ...
            <div className="bg-background rounded-lg p-8 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    We use analytics cookies to understand how you use our website so we can improve it. These cookies collect information such as:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <h2 className="text-2xl font-bold mb-6 mt-12">Third-Party Cookies</h2>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-6">
                ...
                <li><strong>Netlify:</strong> For deployment and hosting services</li>
              </ul>

              <h2 className="text-2xl font-bold mb-6 mt-12">Managing Cookies</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Use the preference center above to control which types of cookies we can use. Your preferences will be saved and respected across your visits.
                  </p>
                </div>
              ...
              <h2 className="text-2xl font-bold mb-6 mt-12">Updates to This Policy</h2>
