...
export default function ProjectSetupPage() {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<TechTemplate | null>(
    null
  );
  ...
  const handleCreateProject = async () => {
    ...
    try {
      ...
      if (userProject) {
        ...
        router.push(
          `/ide/${userProject.id}?template=${
            selectedTemplate.id
          }&language=${selectedLanguage}&name=${encodeURIComponent(
            project.name
      ...
      addToast(toast.error("Failed to create project. Please try again."));
    } finally {
      setIsCreating(false);
    }
  };
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-700 text-sm mt-1">
                        You&#39;ve already submitted and earned points for this
                        project. You can still work on it for practice, but
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Project names are automatically generated and cannot be
                    edited
                  </p>
                </div>
                      ...
                      <div className="flex gap-2">
                        <Badge variant="outline" className="text-xs">
                          ...
                          (selectedTemplate.language === "javascript" ||
                            selectedTemplate.id.includes("react") ||
                            selectedTemplate.id.includes("nextjs") ||
                            selectedTemplate.id.includes("vue") ||
                            selectedTemplate.id.includes("nodejs"))
                            ? "TypeScript"
