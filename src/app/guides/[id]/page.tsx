    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">The learning guide you're looking for doesn't exist.</p>
          <Link href="/guides">
        ...
        >
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <div className="text-sm text-muted-foreground">{guide.duration}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <div className="text-sm text-muted-foreground">{guide.steps.length} learning modules</div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <div className="text-sm text-muted-foreground">{guide.rating}/5.0</div>
            </CardContent>
          </Card>
        </motion.div>
