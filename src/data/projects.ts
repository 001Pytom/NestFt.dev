...
export const beginnerProjects: ProjectTemplate[] = [
  ...
  },
  {
    ...
    name: "Weather App",
    description:
      "Build a weather application that fetches current weather data and displays forecasts for different cities.",
    stack: "frontend",
    difficulty: "beginner",
  ...
  },
  {
    ...
    description:
      "Create a fully functional todo list with add, edit, delete, and filter capabilities.",
    stack: "frontend",
    difficulty: "beginner",
    technologies: ["HTML", "CSS", "JavaScript"],
    estimatedHours: 6,
  ...
  // Continue with more beginner projects...
  {
    ...
    name: "Calculator App",
    description:
      "Build a functional calculator with basic arithmetic operations and memory functions.",
    stack: "frontend",
    difficulty: "beginner",
    technologies: ["HTML", "CSS", "JavaScript"],
    estimatedHours: 5,
  ...
  },
  {
    ...
    name: "Image Gallery",
    description:
      "Create an interactive image gallery with lightbox functionality and filtering options.",
    stack: "frontend",
    difficulty: "beginner",
    technologies: ["HTML", "CSS", "JavaScript"],
    estimatedHours: 7,
...
export const intermediateProjects: ProjectTemplate[] = [
  {
    ...
    description:
      "Build a complete e-commerce product catalog with shopping cart, user authentication, and payment integration.",
    stack: "fullstack",
  ...
  },
  {
    ...
    description:
      "Create a real-time chat application with multiple rooms, private messaging, and file sharing.",
    stack: "fullstack",
    difficulty: "intermediate",
...
export const advancedProjects: ProjectTemplate[] = [
  {
    ...
    description:
      "Build a comprehensive e-learning platform using microservices architecture with video streaming, progress tracking, and AI-powered recommendations.",
    stack: "fullstack",
    difficulty: "advanced",
    technologies: [
      "React",
...
export const beginnerBackendProjects: ProjectTemplate[] = [
  {
    ...
    description:
      "Build a basic REST API with CRUD operations for managing a simple resource like books or users.",
    stack: "backend",
    difficulty: "beginner",
  ...
  },
  {
    ...
    description:
      "Create a simple file upload service that accepts files and stores them with metadata.",
    stack: "backend",
    difficulty: "beginner",
...
export const intermediateBackendProjects: ProjectTemplate[] = [
  {
    ...
    description:
      "Build a complete authentication system with JWT tokens, password hashing, and user management.",
    stack: "backend",
    difficulty: "intermediate",
...
export const advancedBackendProjects: ProjectTemplate[] = [
  {
    ...
    description:
      "Build a microservices-based e-commerce backend with user service, product service, order service, and payment service.",
    stack: "backend",
    difficulty: "advanced",
    technologies: [
      "Node.js",
